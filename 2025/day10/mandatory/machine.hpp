...
/*   Updated: 2025/12/10 19:50:33 by tchartie         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
class Machines {
	...
	private:
		...
		int	parseLights(const str &s);
		int	parseButton(const str &s);
		int	minPresses(int target, const std::vector<int> &buttons);
};
